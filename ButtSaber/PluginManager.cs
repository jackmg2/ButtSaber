...
namespace ButtSaber
{
    class PluginManager
    {
        ...
        public Version LocalVersion => _localVersion ?? IPA.Loader.PluginManager.GetPluginFromId("ButtSaber").HVersion;
        ...
        private async Task<Release> GetNewestReleaseAsyncInternal()
        {
            try
            {
                ...
                var response = await client.GetStringAsync("https://api.github.com/repos/Jackmg2/Buttsaber/releases");
